  ...
  return (
    <div id="about" className="cadre bg-gray-50 py-24 px-6 md:px-12 lg:px-24">
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <div className="bg-white shadow-md rounded-2xl p-8 hover:shadow-lg transition flex flex-col">
          <h3 className="text-2xl font-bold text-green-700 mb-6 border-b-4 border-yellow-400 inline-block pb-2">
            ÉDUCATION
          </h3>
          <p className="text-gray-700 space-y-3 leading-relaxed list-disc list-inside flex-1">
